...
const Header = () => {
  ...
  return (
    <header className="fixed top-10 left-0 right-0 z-40 bg-white/95 backdrop-blur-sm border-b border-border shadow-[var(--shadow-card)] transition-all duration-300">
