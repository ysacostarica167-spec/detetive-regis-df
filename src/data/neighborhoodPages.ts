...
export const neighborhoodPages: NeighborhoodPage[] = [
  {
    slug: "detetive-aguas-claras-df",
    name: "Águas Claras",
    title: "Detetive Particular em Águas Claras DF",
    ...
    intro: [
      ...
      "Se você mora ou trabalha em Águas Claras e precisa de um investigador particular confiável, o Detetive Regis oferece consulta gratuita e 100% sigilosa. Não importa a complexidade do caso — investigação conjugal, empresarial ou localização de pessoas — temos a experiência necessária para entregar resultados."
    ],
    services: [
      "Investigação conjugal e de infidelidade em Águas Claras",
      "Monitoramento e vigilância discreta em condomínios",
      "Investigação empresarial para empresas da região",
      "Localização de pessoas e levantamento de endereço",
      "Investigação patrimonial e financeira",
      "Coleta de provas para processos judiciais"
    ],
    localInfo: [
      "Nossa familiaridade com o layout urbano de Águas Claras — incluindo o Parque Ecológico, a Avenida Araucárias e os principais condomínios — nos permite conduzir operações de campo com máxima eficiência. Conhecemos os horários de maior movimentação, as rotas alternativas e os pontos estratégicos de observação.",
      "Águas Claras possui uma concentração significativa de profissionais liberais e famílias jovens, o que gera demanda constante por investigações conjugais e verificação de antecedentes. Atendemos com a sensibilidade que cada caso exige, sempre priorizando o bem-estar emocional do cliente."
    ],
    nearby: ["Taguatinga", "Vicente Pires", "Arniqueira", "Park Way", "Guará"]
  },
  {
    slug: "detetive-taguatinga-df",
    name: "Taguatinga",
    title: "Detetive Particular em Taguatinga DF",
    ...
    intro: [
      ...
      "Oferecemos atendimento imediato e sigiloso para moradores e empresários de Taguatinga. Nossa equipe está preparada para lidar com casos de investigação conjugal, fraudes empresariais, localização de pessoas e muito mais — sempre com profissionalismo e discrição absoluta."
    ],
    services: [
      "Investigação de traição e infidelidade em Taguatinga",
      "Monitoramento de funcionários e sócios comerciais",
      "Localização de devedores e pessoas desaparecidas",
      "Verificação de antecedentes e due diligence",
      "Investigação de fraudes internas em empresas",
      "Produção de provas legais para processos judiciais"
    ],
    localInfo: [
      "Taguatinga possui uma dinâmica urbana intensa, com grande circulação de pessoas em áreas comerciais como o Pistão Norte, Pistão Sul e as proximidades da estação do metrô. Essa movimentação exige um investigador experiente, capaz de se mesclar ao ambiente sem chamar atenção.",
      "A região também abriga um expressivo número de pequenas e médias empresas, muitas das quais recorrem aos nossos serviços de investigação empresarial para proteger seus negócios contra fraudes, concorrência desleal e desvios internos."
    ],
    nearby: ["Ceilândia", "Samambaia", "Águas Claras", "Vicente Pires", "Recanto das Emas"]
  },
  {
    slug: "detetive-asa-norte",
    name: "Asa Norte",
    title: "Detetive Particular na Asa Norte - Brasília",
    ...
    intro: [
      ...
      "Se você precisa de um detetive particular na Asa Norte, oferecemos consulta gratuita e absolutamente sigilosa. Atendemos casos de investigação conjugal, verificação de condutas, localização de pessoas e investigações empresariais com a discrição que a região exige."
    ],
    services: [
      "Investigação conjugal discreta nas superquadras",
      "Monitoramento e vigilância na Asa Norte e W3",
      "Investigação empresarial no setor comercial norte",
      "Localização de pessoas e levantamento cadastral",
      "Verificação de antecedentes para contratações",
      "Documentação fotográfica e em vídeo para provas"
    ],
    localInfo: [
      "A Asa Norte possui um layout urbano planejado que facilita a circulação, mas também exige cuidado especial em operações de vigilância — moradores são atentos e o ambiente é relativamente tranquilo. Nossa experiência na região permite atuar sem despertar qualquer suspeita.",
      "A presença da UnB e de diversos órgãos públicos na Asa Norte também gera demanda por investigações acadêmicas e verificação de fraudes institucionais. Atendemos com ética e total conformidade legal."
    ],
    nearby: ["Noroeste", "Lago Norte", "Varjão", "Asa Sul", "Setor de Clubes Norte"]
  },
  {
    slug: "detetive-asa-sul",
    name: "Asa Sul",
    title: "Detetive Particular na Asa Sul - Brasília",
    ...
    intro: [
      ...
      "Para moradores e empresários da Asa Sul que necessitam de investigação particular, oferecemos consulta inicial gratuita. Tratamos cada caso com a máxima confidencialidade, entregando relatórios claros e provas legítimas que podem ser utilizadas judicialmente."
    ],
    services: [
      "Investigação conjugal e de infidelidade na Asa Sul",
      "Vigilância discreta em superquadras e comércios locais",
      "Investigação empresarial para escritórios e empresas",
      "Localização de pessoas e análise de paradeiro",
      "Levantamento patrimonial e financeiro",
      "Produção de provas para divórcio e guarda"
    ],
    localInfo: [
      "A Asa Sul concentra um público de alto poder aquisitivo, incluindo profissionais liberais, servidores públicos de alto escalão e empresários. Essa realidade exige um investigador que compreenda a dinâmica social da região e atue com a máxima discrição possível.",
      "Nosso escritório na Asa Sul nos permite responder rapidamente a qualquer demanda, com atendimento presencial agendado ou emergencial. Estamos a poucos minutos de qualquer ponto da região, garantindo agilidade nas operações."
    ],
    nearby: ["Sudoeste", "Cruzeiro", "Lago Sul", "Asa Norte", "Octogonal"]
  },
  {
    slug: "detetive-lago-sul",
    name: "Lago Sul",
    title: "Detetive Particular no Lago Sul - Brasília",
    ...
    intro: [
      ...
      "Nossos serviços no Lago Sul incluem investigação conjugal de alto perfil, verificação patrimonial, monitoramento de condutas e investigações que envolvem figuras públicas e empresários influentes — sempre com ética e dentro da legalidade."
    ],
    services: [
      "Investigação conjugal discreta para famílias de alto perfil",
      "Levantamento patrimonial e financeiro detalhado",
      "Monitoramento de condutas e rotinas",
      "Investigação de fraudes e desvios",
      "Verificação de funcionários domésticos e prestadores",
      "Produção de provas para processos de família"
    ],
    localInfo: [
      "O Lago Sul possui características únicas — ruas tranquilas, pouca movimentação de pedestres e residências com segurança privada. Essas particularidades exigem técnicas investigativas especializadas e equipamentos de última geração para garantir operações bem-sucedidas.",
      "Muitos dos nossos clientes no Lago Sul são indicações de escritórios de advocacia e profissionais de confiança da região. Essa rede de recomendações reflete a qualidade e seriedade do nosso trabalho ao longo de mais de duas décadas."
    ],
    nearby: ["Park Way", "Jardim Botânico", "São Sebastião", "Asa Sul", "Lago Norte"]
  },
  {
    slug: "detetive-lago-norte",
    name: "Lago Norte",
    title: "Detetive Particular no Lago Norte - Brasília",
    ...
    intro: [
      ...
      "Oferecemos atendimento personalizado para moradores do Lago Norte, com consulta inicial gratuita e planejamento estratégico de cada operação. Cada caso é tratado com exclusividade, garantindo resultados confiáveis e provas legalmente válidas."
    ],
    services: [
      "Investigação conjugal e de infidelidade no Lago Norte",
      "Verificação de antecedentes de funcionários e prestadores",
      "Monitoramento discreto em áreas residenciais exclusivas",
      "Investigação patrimonial para processos de divórcio",
      "Localização de pessoas e levantamento de paradeiro",
      "Análise de condutas e rotinas suspeitas"
    ],
    localInfo: [
      "O Lago Norte apresenta um ambiente residencial de baixa densidade, com ruas arborizadas e pouca circulação, o que torna operações de vigilância mais delicadas. Nossa equipe utiliza técnicas e equipamentos especializados para atuar com total invisibilidade.",
      "A proximidade com a Granja do Torto, o Parque Nacional de Brasília e as quadras diplomáticas adiciona camadas de complexidade às investigações na região. O Detetive Regis possui a experiência necessária para lidar com cenários de alta sensibilidade."
    ],
    nearby: ["Asa Norte", "Varjão", "Sobradinho", "Lago Sul", "Noroeste"]
  },
  {
    slug: "detetive-sudoeste",
    name: "Sudoeste",
    title: "Detetive Particular no Sudoeste - Brasília",
    ...
    intro: [
      ...
      "Se você reside no Sudoeste ou na Octogonal e precisa de um detetive particular confiável, oferecemos atendimento imediato e consulta gratuita. Nossos serviços incluem investigação conjugal, monitoramento de condutas e produção de provas para uso judicial."
    ],
    services: [
      "Investigação conjugal no Sudoeste e Octogonal",
      "Vigilância discreta em condomínios residenciais",
      "Investigação empresarial e de sócios",
      "Localização de pessoas e análise de paradeiro",
      "Levantamento patrimonial para processos judiciais",
      "Verificação de antecedentes e due diligence"
    ],
    localInfo: [
      "O Sudoeste possui uma estrutura urbana planejada com quadras bem definidas e alta segurança condominial. Operações de investigação na região exigem planejamento detalhado e equipamentos discretos — áreas em que o Detetive Regis se destaca com mais de 20 anos de experiência.",
      "A Octogonal, adjacente ao Sudoeste, também é atendida por nossa equipe. A região combina edifícios residenciais com áreas comerciais movimentadas, exigindo versatilidade e conhecimento local do investigador."
    ],
    nearby: ["Cruzeiro", "Asa Sul", "Noroeste", "Park Way", "Núcleo Bandeirante"]
  },
  {
    slug: "detetive-cruzeiro",
    name: "Cruzeiro",
    title: "Detetive Particular no Cruzeiro - Brasília",
    ...
    intro: [
      ...
      "Oferecemos consulta gratuita e sigilosa para moradores do Cruzeiro. Seja para confirmar uma suspeita de infidelidade, localizar uma pessoa ou investigar uma fraude, o Detetive Regis tem a experiência e os recursos necessários para resolver o seu caso."
    ],
    services: [
      "Investigação de infidelidade no Cruzeiro Velho e Novo",
      "Monitoramento e vigilância em áreas residenciais",
      "Investigação empresarial para comércios locais",
      "Localização de pessoas e devedores",
      "Produção de provas fotográficas e em vídeo",
      "Investigação de antecedentes e conduta"
    ],
    localInfo: [
      "O Cruzeiro possui uma dinâmica de bairro tradicional, onde moradores frequentam os mesmos estabelecimentos e se reconhecem. Isso torna operações de vigilância mais desafiadoras, exigindo um profissional que saiba se posicionar estrategicamente sem chamar atenção.",
      "A localização central do Cruzeiro — próximo à Asa Sul, Sudoeste e Octogonal — também nos permite estender operações para regiões vizinhas quando necessário, sem perda de eficiência."
    ],
    nearby: ["Sudoeste", "Octogonal", "Asa Sul", "Núcleo Bandeirante", "Guará"]
  }
];
